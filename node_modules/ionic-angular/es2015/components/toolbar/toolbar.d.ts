...
export declare class Toolbar extends ToolbarBase {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<Toolbar, "ion-toolbar", never, {}, {}, never, ["[menuToggle],ion-buttons[left]", "ion-buttons[start]", "ion-buttons[end],ion-buttons[right]", "*"], false>;
}
