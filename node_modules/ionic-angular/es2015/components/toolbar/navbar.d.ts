...
export declare class Navbar extends ToolbarBase {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<Navbar, "ion-navbar", never, { "hideBackButton": "hideBackButton"; }, {}, never, ["[menuToggle],ion-buttons[left]", "ion-buttons[start]", "ion-buttons[end],ion-buttons[right]", "*"], false>;
}
