...
export declare class Tabs extends Ion implements AfterViewInit, RootNode, ITabs, NavigationContainer {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<Tabs, "ion-tabs", never, { "tabsHighlight": "tabsHighlight"; "name": "name"; "selectedIndex": "selectedIndex"; "tabsLayout": "tabsLayout"; "tabsPlacement": "tabsPlacement"; }, { "ionChange": "ionChange"; }, never, ["*"], false>;
}
