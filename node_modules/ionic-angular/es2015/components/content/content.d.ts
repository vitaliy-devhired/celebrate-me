...
export declare class Content extends Ion implements OnDestroy, AfterViewInit, IContent {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<Content, "ion-content", never, { "fullscreen": "fullscreen"; "scrollDownOnLoad": "scrollDownOnLoad"; }, { "ionScrollStart": "ionScrollStart"; "ionScroll": "ionScroll"; "ionScrollEnd": "ionScrollEnd"; }, never, ["[ion-fixed],ion-fab", "*", "ion-refresher"], false>;
}
