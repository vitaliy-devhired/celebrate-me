...
export declare class Range extends BaseInput<any> implements AfterContentInit, ControlValueAccessor, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<Range, "ion-range", never, { "min": "min"; "max": "max"; "step": "step"; "snaps": "snaps"; "pin": "pin"; "debounce": "debounce"; "dualKnobs": "dualKnobs"; }, {}, never, ["[range-left]", "[range-right]"], false>;
}
