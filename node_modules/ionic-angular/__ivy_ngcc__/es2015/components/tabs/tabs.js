...
import * as ɵngcc9 from './tab-button';
import * as ɵngcc10 from './tab-highlight';
...
function Tabs_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("ionSelect", function Tabs_a_2_Template_a_ionSelect_0_listener() { const restoredCtx = ɵngcc0.ɵɵrestoreView(_r5); const t_r3 = restoredCtx.$implicit; const ctx_r4 = ɵngcc0.ɵɵnextContext(); return ɵngcc0.ɵɵresetView(ctx_r4.select(t_r3)); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
Tabs.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: Tabs, selectors: [["ion-tabs"]], viewQuery: function Tabs_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, dependencies: [ɵngcc8.NgForOf, ɵngcc9.TabButton, ɵngcc10.TabHighlight], encapsulation: 2 });
/** @nocollapse */
Tabs.ctorParameters = () => [
